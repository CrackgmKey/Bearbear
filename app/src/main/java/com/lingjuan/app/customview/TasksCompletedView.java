...
//		mTextPaint.setARGB(255, 255, 255, 255);
    ...
    protected void onDraw(Canvas canvas) {
       ...
       // System.out.println("当前的值：mXCenter"+mXCenter+",mYCenter"+mYCenter+",mRadius:"+mRadius);
        ...
        if (mProgress >= 0) {
            ...
            System.out.println("当前的值：mXCenter"+((float) mProgress / mTotalProgress) * 360);
